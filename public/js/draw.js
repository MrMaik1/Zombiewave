...
function draw(){
  ...
  G.enemies.forEach(e=>{const sx=e.x+cx,sy=e.y+cy;if(sx<-80||sx>W+80||sy<-100||sy>H+100)return;if(e.type==='a')drawZombieA(sx,sy,e.size,e.hp,e.maxHp,e.hat,e.tick||0);else if(e.type==='b')drawZombieB(sx,sy,e.size,e.hp,e.maxHp,e.tick||0);else if(e.type==='c')drawZombieC(sx,sy,e.size,e.hp,e.maxHp,e.tick||0);else if(e.type==='d')drawZombieD(sx,sy,e.size,e.hp,e.maxHp,e.tick||0);else if(e.type==='e')drawZombieE(sx,sy,e.size,e.hp,e.maxHp,e.tick||0);else if(e.type==='f')drawZombieF(sx,sy,e.size,e.hp,e.maxHp,e.tick||0);});
...
function drawZombieD(sx,sy,sz,hp,maxHp,tick){ctx.save();ctx.translate(sx,sy);const s=sz/15;ctx.scale(s,s);const bob=Math.sin((tick||0)*.1)*2;ctx.translate(0,bob);ctx.fillStyle='rgba(0,0,0,.2)';ctx.beginPath();ctx.ellipse(0,16,8,3,0,0,Math.PI*2);ctx.fill();px2(-5,5,5,10,'#8b4513');px2(0,5,5,10,'#8b4513');px2(-7,13,6,4,'#111');px2(1,13,6,4,'#111');px2(-8,-1,16,8,'#cc5500');px2(-12,0,5,5,'#e07020');px2(7,0,5,5,'#e07020');px2(-8,-14,16,14,'#e06000');px2(-5,-9,4,4,'#ff3300');px2(1,-9,4,4,'#ff3300');ctx.fillStyle='#111';ctx.fillRect(-5,-4,10,3);px2(-1,-17,2,5,'#f7c948');ctx.fillStyle='#ff6600';ctx.beginPath();ctx.arc(0,-18,3,0,Math.PI*2);ctx.fill();ctx.strokeStyle=`rgba(255,100,0,${0.35+Math.sin((tick||0)*.25)*.25})`;ctx.lineWidth=2;ctx.beginPath();ctx.arc(0,0,22,0,Math.PI*2);ctx.stroke();drawZHPbar(hp,maxHp);ctx.restore();}
function drawZombieE(sx,sy,sz,hp,maxHp,tick){ctx.save();ctx.translate(sx,sy);const s=sz/20;ctx.scale(s,s);const bob=Math.sin((tick||0)*.05)*1.5;ctx.translate(0,bob);ctx.fillStyle='rgba(0,0,0,.2)';ctx.beginPath();ctx.ellipse(0,22,11,4,0,0,Math.PI*2);ctx.fill();ctx.fillStyle='#5a0080';ctx.beginPath();ctx.moveTo(-12,20);ctx.lineTo(-10,-2);ctx.lineTo(10,-2);ctx.lineTo(12,20);ctx.closePath();ctx.fill();px2(-20,0,12,6,'#3a7a3a');px2(8,0,12,6,'#3a7a3a');ctx.fillStyle='rgba(50,255,80,.7)';ctx.beginPath();ctx.arc(-22,3,5,0,Math.PI*2);ctx.fill();ctx.beginPath();ctx.arc(22,3,5,0,Math.PI*2);ctx.fill();ctx.fillStyle='#3a6b3a';ctx.beginPath();ctx.arc(0,-14,12,0,Math.PI*2);ctx.fill();ctx.fillStyle='#3a0055';ctx.beginPath();ctx.arc(0,-16,13,Math.PI,0);ctx.fill();px2(-6,-10,4,4,'#cc00ff');px2(2,-10,4,4,'#cc00ff');ctx.fillStyle='#111';ctx.fillRect(-5,-5,10,3);ctx.strokeStyle=`rgba(50,200,80,${0.2+Math.sin((tick||0)*.15)*.18})`;ctx.lineWidth=3;ctx.beginPath();ctx.arc(0,0,28,0,Math.PI*2);ctx.stroke();drawZHPbar(hp,maxHp);ctx.restore();}
function drawZombieF(sx,sy,sz,hp,maxHp,tick){ctx.save();ctx.translate(sx,sy);const s=sz/30;ctx.scale(s,s);const bob=Math.sin((tick||0)*.04)*3;ctx.translate(0,bob);ctx.fillStyle='rgba(0,0,0,.35)';ctx.beginPath();ctx.ellipse(0,32,22,6,0,0,Math.PI*2);ctx.fill();px2(-16,14,13,22,'#1e4a1e');px2(3,14,13,22,'#1e4a1e');px2(-20,34,14,8,'#111');px2(6,34,14,8,'#111');ctx.fillStyle='#1a4a1a';ctx.beginPath();ctx.ellipse(0,2,22,20,0,0,Math.PI*2);ctx.fill();ctx.fillStyle='#4a4a4a';ctx.beginPath();ctx.ellipse(0,0,18,14,0,0,Math.PI*2);ctx.fill();ctx.strokeStyle='#2a2a2a';ctx.lineWidth=2;ctx.stroke();px2(-32,-4,16,10,'#1a4a1a');px2(16,-4,16,10,'#1a4a1a');px2(-38,-5,8,14,'#2a6a2a');px2(30,-5,8,14,'#2a6a2a');ctx.fillStyle='#1a4a1a';ctx.beginPath();ctx.arc(0,-22,18,0,Math.PI*2);ctx.fill();ctx.fillStyle='#333';ctx.beginPath();ctx.arc(0,-24,19,Math.PI,0);ctx.fill();ctx.fillStyle='#ff2200';ctx.beginPath();ctx.arc(-8,-24,7,0,Math.PI*2);ctx.fill();ctx.beginPath();ctx.arc(8,-24,7,0,Math.PI*2);ctx.fill();ctx.fillStyle='#ff6600';ctx.beginPath();ctx.arc(-8,-24,4,0,Math.PI*2);ctx.fill();ctx.beginPath();ctx.arc(8,-24,4,0,Math.PI*2);ctx.fill();ctx.fillStyle='#111';ctx.fillRect(-12,-18,24,6);ctx.fillStyle='#eee';[-8,-4,0,4,8].forEach(tx2=>ctx.fillRect(tx2,-18,3,5));const bw=60;ctx.fillStyle='rgba(0,0,0,.6)';ctx.fillRect(-bw/2,36,bw,7);ctx.fillStyle=hp/maxHp>.5?'#27ae60':hp/maxHp>.25?'#f39c12':'#c0392b';ctx.fillRect(-bw/2,36,bw*(hp/maxHp),7);ctx.restore();}
