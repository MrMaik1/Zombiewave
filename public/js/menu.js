...
function positionAdminPanels() {
  ...
  if (adminBtn)    { adminBtn.style.right    = Math.max(8, right + 8) + 'px'; adminBtn.style.top    = (top + 8) + 'px'; }
  if (adminPanel)  { adminPanel.style.right  = Math.max(8, right + 8) + 'px'; adminPanel.style.top  = (top + 46) + 'px'; }
  if (grantedBtn)  { grantedBtn.style.right  = Math.max(96, right + 96) + 'px'; grantedBtn.style.top  = (top + 8) + 'px'; }
  if (grantedPanel){ grantedPanel.style.right= Math.max(96, right + 96) + 'px'; grantedPanel.style.top= (top + 46) + 'px'; }
}
